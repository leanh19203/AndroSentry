...
export const TRANSLATIONS: Record<string, any> = {
  vi: {
    ...
    tabStaticScan: "Phân tích Tĩnh",
    tabMoreBtnTitle: "Menu nhanh các tính năng",
    tabMoreBtnLabel: "Tính năng",
    tabMoreBtnHeader: "DANH SÁCH TÍNH NĂNG",
    ...
    // Frida Studio (Interactive & AI)
    fridaStudioTitle: "Frida Studio: Bộ Dựng Mã Tương Tác & Trí Tuệ Nhân Tạo (Gemini)",
    fridaStudioDesc: "Tối ưu hóa quy trình Dynamic Analysis của bạn bằng cách thiết kế nhanh các script Hooking theo tham số, hoặc yêu cầu AI (Gemini) sinh tự động các kịch bản bypass nâng cao.",
    fridaTabPresets: "Thư viện mẫu Bypass",
    fridaTabBuilder: "Dựng mã tương tác",
    fridaTabAI: "AI sinh Frida Script 🤖",
    fridaLabelClass: "Tên Lớp (Class Name)",
    fridaLabelMethod: "Tên Phương thức (Method Name)",
    fridaLabelParams: "Các kiểu tham số (cách nhau bởi dấu phẩy)",
    fridaLabelAction: "Hành động Hook",
    fridaLabelDelay: "Trì hoãn thực thi (ms)",
    fridaBtnGenerate: "Tạo kịch bản Hook",
    fridaAIPromptPlaceholder: "Mô tả kịch bản cần AI viết. Ví dụ: 'Bypass SSL Pinning OkHttp3', 'Hook và in ra các tham số của hàm mã hóa AES', 'Bypass Root Detection của ứng dụng'...",
    fridaAIBtn: "Yêu cầu Gemini thiết kế Script",
    fridaLabelPackage: "Tên gói ứng dụng (Package Name)",
    fridaActionLog: "In tham số và giá trị trả về (Log arguments & returns)",
    fridaActionTrue: "Ghi đè giá trị trả về thành TRUE",
    fridaActionFalse: "Ghi đè giá trị trả về thành FALSE",
    fridaActionCustom: "Trả về giá trị Số nguyên tùy chỉnh",
    fridaActionVoid: "Hook hàm Void (Không trả về giá trị)",
    fridaCustomIntLabel: "Giá trị số nguyên trả về",
    fridaGeneratedScriptHeader: "Kịch bản Frida được tạo lập thành công:",
    fridaAIExplanationHeader: "Giải thích cơ chế & Cách thực thi:",
    ...
    // Static Scan Tab (SAST)
    sastTitle: "Phân tích Tĩnh",
    sastScoreLabel: "Điểm",
    sastCatHardcodedSecrets: "Khóa bí mật nhúng sẵn (Hardcoded Secrets)",
    sastCatWeakCryptography: "Thuật toán mã hóa yếu (Weak Crypto)",
    sastCatWebViewRisk: "Nguy cơ WebView (WebView Risk)",
    sastCatSslPinning: "Cấu hình mạng & SSL Pinning",
    sastCatExportedComponents: "Thành phần Exported nguy hiểm",
    sastCatSqlInjection: "Lỗ hổng SQL Injection",
    sastCatCommandExecution: "Thực thi lệnh hệ thống",
    sastCatDebugLog: "Rò rỉ nhật ký Debug Log",
    sastDesc: "Tự động phân tích sâu mã nguồn (.java, .kt, .smali) và các tệp cấu hình để phát hiện lỗi bảo mật, hardcoded API key, hoặc cấu hình sai theo tiêu chuẩn OWASP Mobile Top 10.",
    sastWorkspaceLabel: "Thư mục / Mã nguồn quy trình (Tùy chọn):",
    sastWorkspaceSub: "Mặc định hệ thống tự động tìm thư mục decompile JADX/Apktool gần nhất.",
    sastBtnRun: "Kích hoạt Quét Mã nguồn",
    sastScanningState: "Đang phân tích mã...",
    sastErrorTitle: "Lỗi phân tích:",
    sastErrorSub: "Hãy đảm bảo bạn đã thực hiện giải nén APK bằng JADX hoặc Apktool trước. Nếu bạn đang chạy chế độ trực tuyến, bạn hãy nhấn nút đỏ Simulation Mode ở thanh điều khiển Console để trải nghiệm demo ảo.",
    sastLoadingTitle: "Đang phân tích tĩnh toàn bộ mã nguồn...",
    sastLoadingDesc: "Duyệt tìm tệp cấu hình XML, bóc tách chuỗi mã nguồn Java/Smali, kiểm tra các entropy API key nhạy cảm và đối chiếu biểu thức chính quy bảo mật...",
    sastEmptyTitle: "Chưa kích hoạt quét mã nguồn tĩnh",
    sastEmptyDesc: "Nhấp nút 'Kích hoạt Quét Mã nguồn' để hệ thống tự động tìm mã nguồn decompiled và phân tích các nguy cơ tiềm ẩn.",
    sastRulesHeader: "Bộ lọc bảo mật tích hợp",
    sastRatingTitle: "KẾT QUẢ ĐÁNH GIÁ",
    sastRatingGood: "Bảo mật Tốt",
    sastRatingWarn: "Cảnh báo",
    sastRatingDanger: "Mức độ rủi ro lớn",
    sastFilesScanned: "Tệp đã quét:",
    sastVulnerabilities: "Lỗ hổng phát hiện:",
    sastBtnMd: "Báo cáo .MD",
    sastBtnHtml: "Báo cáo HTML",
    sastFilterCat: "Tất cả danh mục",
    sastFilterSev: "Tất cả mức độ",
    sastSearchPlaceholder: "Tìm kiếm tệp, chuỗi mã nguồn...",
    sastFindingsTitle: "DANH SÁCH LỖ HỔNG PHÁT HIỆN",
    sastNoFilteredFindings: "Không tìm thấy lỗ hổng nào phù hợp với bộ lọc và từ khóa tìm kiếm của bạn.",
    sastSuspiciousCode: "PHÁT HIỆN MÃ NGUỒN NGHI VẤN:",
    sastRiskDesc: "MÔ TẢ NGUY CƠ BẢO MẬT:",
    sastRemediation: "HƯỚNG DẪN KHẮC PHỤC & THIẾT KẾ AN TOÀN:",
    sastFilePosition: "ĐƯỜNG DẪN TỆP & DÒNG MÃ:",
    sastCategoryLabel: "DANH MỤC:",
    sastSeverityLabel: "MỨC ĐỘ:",
    sastLineLabel: "Dòng",
    sastReportTitle: "BÁO CÁO PHÂN TÍCH BẢO MẬT TĨNH - ANDROSENTRY",
    sastReportTime: "Thời gian quét:",
    sastReportMode: "Chế độ quét:",
    sastReportModeSim: "Mô phỏng (Simulation)",
    sastReportModeReal: "Thực tế trên Localhost",
    sastReportWorkspace: "Thư mục phân tích:",
    sastReportScore: "Điểm số an toàn mã nguồn:",
    sastReportSummary: "1. Tóm tắt kết quả phân tích",
    sastReportStats: "2. Thống kê số lượng",
    sastReportFilesScannedStat: "Tổng số tệp quét:",
    sastReportVulnerabilitiesStat: "Tổng số lỗ hổng phát hiện:",
    sastReportDetails: "3. Chi tiết các lỗ hổng phát hiện (lọc được)",
    sastReportClassification: "Phân loại:",
    sastReportFilePath: "Tệp tin:",
    sastReportCodeSnippet: "Mã nguồn phát hiện:",
    sastReportDetailDesc: "Mô tả chi tiết:",
    sastReportGuideRemediation: "Hướng dẫn khắc phục:",
    sastReportEmptyFindings: "Không tìm thấy lỗ hổng nào khớp với bộ lọc hiện tại.",
    sastReportFooter: "Báo cáo phân tích được kết xuất bởi AndroSentry - Trợ lý Kiểm thử Xâm nhập Di động Chuyên nghiệp."
  },
  en: {
    title: "AndroSentry",
    ...
    tabStaticScan: "Static Security Scanner",
    tabMoreBtnTitle: "Quick features menu",
    tabMoreBtnLabel: "Features",
    tabMoreBtnHeader: "FEATURES DIRECTORY",
    aiBadge: "AI Powered",
    ...
    // Frida Studio (Interactive & AI)
    fridaStudioTitle: "Frida Studio: Interactive & AI Script Builder (Gemini)",
    fridaStudioDesc: "Accelerate your dynamic security analysis workflow by parameterizing hooks on-the-fly, or let Gemini auto-generate advanced security bypasses.",
    fridaTabPresets: "Bypass Presets Library",
    fridaTabBuilder: "Interactive Builder",
    fridaTabAI: "AI Script Generator 🤖",
    fridaLabelClass: "Class Name",
    fridaLabelMethod: "Method Name",
    fridaLabelParams: "Parameter Types (comma-separated)",
    fridaLabelAction: "Hook Action",
    fridaLabelDelay: "Execution Delay (ms)",
    fridaBtnGenerate: "Generate Hook Script",
    fridaAIPromptPlaceholder: "Describe the Frida script you want. E.g. 'Bypass SSL Pinning for OkHttp3', 'Intercept and print AES encryption keys', 'Bypass Rootbeer root detection'...",
    fridaAIBtn: "Generate Script with Gemini",
    fridaLabelPackage: "Package Name",
    fridaActionLog: "Log arguments & return values",
    fridaActionTrue: "Force return value to TRUE",
    fridaActionFalse: "Force return value to FALSE",
    fridaActionCustom: "Return a custom integer value",
    fridaActionVoid: "Hook Void method (No return value)",
    fridaCustomIntLabel: "Custom Return Integer",
    fridaGeneratedScriptHeader: "Generated Frida Script:",
    fridaAIExplanationHeader: "Mechanism & How to execute:",
    ...
    // Static Scan Tab (SAST)
    sastTitle: "Static Security Analysis",
    sastScoreLabel: "Score",
    sastCatHardcodedSecrets: "Hardcoded Secrets",
    sastCatWeakCryptography: "Weak Cryptography",
    sastCatWebViewRisk: "WebView Risk",
    sastCatSslPinning: "SSL Pinning / Network",
    sastCatExportedComponents: "Exported Components",
    sastCatSqlInjection: "SQL Injection",
    sastCatCommandExecution: "Command Execution",
    sastCatDebugLog: "Debug Log exposure",
    sastDesc: "Automatically scans decompiled Java, Kotlin, Smali, and configuration files to detect hardcoded keys, cryptographic errors, WebView risks, and OWASP Mobile Top 10 threats.",
    sastWorkspaceLabel: "Workspace / Target Directory (Optional):",
    sastWorkspaceSub: "By default, AndroSentry automatically detects the latest decompilation workspace.",
    sastBtnRun: "Run Static Scan",
    sastScanningState: "Scanning Code...",
    sastErrorTitle: "Scan Failed:",
    sastErrorSub: "Please decompile an APK first. If you are using the cloud preview, enable Simulation Mode in the terminal block header to test the interactive features.",
    sastLoadingTitle: "Performing Static Security Analysis...",
    sastLoadingDesc: "Scanning configurations, decompiling artifacts, walking directory trees, and analyzing hardcoded strings against our regex rulesets...",
    sastEmptyTitle: "No Analysis Results Available",
    sastEmptyDesc: "Click the 'Run Static Scan' button on the left panel to scan the active workspace.",
    sastRulesHeader: "Included Analysis Rules",
    sastRatingTitle: "SECURITY AUDIT RATING",
    sastRatingGood: "Secure",
    sastRatingWarn: "Warning",
    sastRatingDanger: "High Risk",
    sastFilesScanned: "Files scanned:",
    sastVulnerabilities: "Vulnerabilities:",
    sastBtnMd: "Export Markdown",
    sastBtnHtml: "Export HTML",
    sastFilterCat: "All Categories",
    sastFilterSev: "All Severities",
    sastSearchPlaceholder: "Search findings, file, code...",
    sastFindingsTitle: "DETECTED VULNERABILITIES",
    sastNoFilteredFindings: "No security issues match your selected filters or search terms.",
    sastSuspiciousCode: "IDENTIFIED SUSPICIOUS CODE:",
    sastRiskDesc: "RISK DESCRIPTION:",
    sastRemediation: "REMEDIATION & SECURE DESIGN:",
    sastFilePosition: "FILE & POSITION:",
    sastCategoryLabel: "CATEGORY:",
    sastSeverityLabel: "SEVERITY:",
    sastLineLabel: "Line",
    sastReportTitle: "STATIC SECURITY ANALYSIS REPORT - ANDROSENTRY",
    sastReportTime: "Scan Time:",
    sastReportMode: "Scan Mode:",
    sastReportModeSim: "Simulation Mode",
    sastReportModeReal: "Local Execution",
    sastReportWorkspace: "Analysis Directory:",
    sastReportScore: "Source Code Security Score:",
    sastReportSummary: "1. Executive Summary",
    sastReportStats: "2. Scan Statistics",
    sastReportFilesScannedStat: "Total Files Scanned:",
    sastReportVulnerabilitiesStat: "Total Vulnerabilities Detected:",
    sastReportDetails: "3. Detailed Findings (Filtered)",
    sastReportClassification: "Category:",
    sastReportFilePath: "File:",
    sastReportCodeSnippet: "Identified Suspicious Code:",
    sastReportDetailDesc: "Detailed Description:",
    sastReportGuideRemediation: "Remediation Guide:",
    sastReportEmptyFindings: "No findings matched the active filters.",
    sastReportFooter: "Report generated by AndroSentry - Professional Android Penetration Testing Suite."
  },
  ja: {
    title: "AndroSentry",
    ...
    tabStaticScan: "静的セキュリティスキャナー",
    tabMoreBtnTitle: "クイック機能メニュー",
    tabMoreBtnLabel: "機能",
    tabMoreBtnHeader: "機能一覧",
    aiBadge: "AI搭載",
    ...
    // Frida Studio (Interactive & AI)
    fridaStudioTitle: "Frida Studio: インタラクティブ & AI スクリプトビルダー (Gemini)",
    fridaStudioDesc: "パラメータをフォームに入力して、独自のFridaフッキングスクリプトを即時生成。またはGemini AIを使って、高度なバイパスロジックを自動生成します。",
    fridaTabPresets: "バイパスプリセット",
    fridaTabBuilder: "対話型スクリプト構築",
    fridaTabAI: "AIスクリプト自動生成 🤖",
    fridaLabelClass: "クラス名 (Class Name)",
    fridaLabelMethod: "メソッド名 (Method Name)",
    fridaLabelParams: "パラメータ型 (カンマ区切り)",
    fridaLabelAction: "フック動作 (Hook Action)",
    fridaLabelDelay: "実行遅延 (ms)",
    fridaBtnGenerate: "フックスクリプトを生成",
    fridaAIPromptPlaceholder: "AIに記述してほしい内容を入力（例：'OkHttp3のSSL Pinning回避', 'AES暗号化キーをログ出力するフック', 'Rootbeerによるルート検知の回避'）...",
    fridaAIBtn: "Geminiにスクリプト作成を指示",
    fridaLabelPackage: "パッケージ名 (Package Name)",
    fridaActionLog: "引数と戻り値をログ出力する",
    fridaActionTrue: "戻り値を TRUE に書き換える",
    fridaActionFalse: "戻り値を FALSE に書き換える",
    fridaActionCustom: "任意の 整数値 を返却する",
    fridaActionVoid: "Voidメソッドをフック（戻り値なし）",
    fridaCustomIntLabel: "返却する整数値",
    fridaGeneratedScriptHeader: "生成された Frida スクリプト:",
    fridaAIExplanationHeader: "動作メカニズムと実行手順:",
    ...
    sastTitle: "静的コード解析",
    sastScoreLabel: "スコア",
    sastCatHardcodedSecrets: "ハードコードされた機密情報",
    sastCatWeakCryptography: "脆弱な暗号化",
    sastCatWebViewRisk: "WebViewの脆弱性",
    sastCatSslPinning: "SSLピン留め/ネットワーク設定",
    sastCatExportedComponents: "エクスポートされたコンポーネント",
    sastCatSqlInjection: "SQLインジェクション",
    sastCatCommandExecution: "コマンド実行の脆弱性",
    sastCatDebugLog: "デバッグログの露出",
    sastDesc: "逆コンパイルされたJava、Kotlin、Smali、マニフェストファイルを自動解析し、APIキー漏洩、暗号化設定ミス、OWASP Mobile Top 10基準の脆弱性を検出します。",
    sastWorkspaceLabel: "ワークスペース / 対象ディレクトリ (オプション):",
    sastWorkspaceSub: "デフォルトでは、直近のJADX/Apktool逆コンパイル出力フォルダを自動で検索します。",
    sastBtnRun: "静的スキャン実行",
    sastScanningState: "コード解析中...",
    sastErrorTitle: "解析失敗:",
    sastErrorSub: "事前にAPKの逆コンパイルを完了させてください。クラウドデモ環境では、コンソールヘッダーにある赤色の「Simulation Mode」をONに切り替えることでシミュレーションスキャンをお試しいただけます。",
    sastLoadingTitle: "全ソースコードを静的解析中...",
    sastLoadingDesc: "XML設定ファイルの走査、Java/Smaliコードの文字列解析、高エントロピーなAPIキーの検出、セキュリティ正規表現との照合処理を実行中...",
    sastEmptyTitle: "静的コードスキャン未実行",
    sastEmptyDesc: "「静的スキャン実行」ボタンをクリックすると、検出されたソースコードから脆弱性や設定ミスを自動的にスキャンします。",
    sastRulesHeader: "搭載セキュリティスキャンルール",
    sastRatingTitle: "セキュリティ評価結果",
    sastRatingGood: "安全",
    sastRatingWarn: "警告",
    sastRatingDanger: "高危険度",
    sastFilesScanned: "スキャンしたファイル数:",
    sastVulnerabilities: "検出された脆弱性:",
    sastBtnMd: "Markdown出力",
    sastBtnHtml: "HTML出力",
    sastFilterCat: "すべてのカテゴリ",
    sastFilterSev: "すべての深刻度",
    sastSearchPlaceholder: "ファイル、検知コード、ルールの検索...",
    sastFindingsTitle: "検出された脆弱性一覧",
    sastNoFilteredFindings: "指定されたフィルタまたは検索キーワードに一致する脆弱性は見つかりませんでした。",
    sastSuspiciousCode: "検出された脆弱なコード箇所:",
    sastRiskDesc: "リスク詳細説明:",
    sastRemediation: "修正方法と安全な設計方針:",
    sastFilePosition: "ファイルと位置:",
    sastCategoryLabel: "カテゴリ:",
    sastSeverityLabel: "深刻度:",
    sastLineLabel: "行",
    sastReportTitle: "静的セキュリティ解析報告書 - ANDROSENTRY",
    sastReportTime: "スキャン時間:",
    sastReportMode: "スキャンモード:",
    sastReportModeSim: "シミュレーションモード",
    sastReportModeReal: "ローカル実機実行",
    sastReportWorkspace: "解析対象フォルダ:",
    sastReportScore: "ソースコードセキュリティスコア:",
    sastReportSummary: "1. 解析概要サマリー",
    sastReportStats: "2. 検出件数統計",
    sastReportFilesScannedStat: "スキャンしたファイル総数:",
    sastReportVulnerabilitiesStat: "検出された脆弱性総数:",
    sastReportDetails: "3. 検出されたセキュリティ脆弱性詳細",
    sastReportClassification: "カテゴリ:",
    sastReportFilePath: "ファイル:",
    sastReportCodeSnippet: "検出されたコード:",
    sastReportDetailDesc: "詳細な説明:",
    sastReportGuideRemediation: "推奨される修正案:",
    sastReportEmptyFindings: "アクティブなフィルタに一致する脆弱性は見つかりませんでした。",
    sastReportFooter: "本報告書は AndroSentry (高度Androidペネトレーションテスト支援スイート) により自動生成されました。"
  }
};
