...
```bash
git clone https://github.com/leanh19203/AndroSentry.git
...
Bạn chỉ cần xóa thư mục chứa dự án mà bạn đã tải về máy Kali (ví dụ thư mục tên là AndroSentry đặt ở thư mục người dùng):
